"""Entry point for 03_receiving on space A_cc with gemini-2.5-flash-lite.
...
EXPERIMENT = "03_receiving"
SPACE = "A_cc"
MODEL = 'google/gemini-2.5-flash-lite'
HERE = Path(__file__).resolve()
EXP_DIR = HERE.parent.parent.parent          # experiments/03_receiving
