"""Entry point for 04_epistemic_networks on space A_gc with gpt-4.1.
...
EXPERIMENT = "04_epistemic_networks"
SPACE = "A_gc"
MODEL = 'openai/gpt-4.1'
HERE = Path(__file__).resolve()
EXP_DIR = HERE.parent.parent.parent          # experiments/04_epistemic_networks
