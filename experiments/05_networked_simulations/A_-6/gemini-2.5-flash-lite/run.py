"""Entry point for 05_networked_simulations on space A_-6 with gemini-2.5-flash-lite.
...
EXPERIMENT = "05_networked_simulations"
SPACE = "A_-6"
MODEL = 'google/gemini-2.5-flash-lite'
HERE = Path(__file__).resolve()
EXP_DIR = HERE.parent.parent.parent          # experiments/05_networked_simulations
