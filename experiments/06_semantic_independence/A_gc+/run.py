"""Entry point for 06_semantic_independence on space A_gc+.
...
EXPERIMENT = "06_semantic_independence"
SPACE = "A_gc+"
MODEL = ''
HERE = Path(__file__).resolve()
EXP_DIR = HERE.parent.parent.parent          # experiments/06_semantic_independence
